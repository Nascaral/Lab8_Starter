    ...
    for (let i = 0; i < RECIPE_URLS.length; i++) {
      ...
      try {
        ...
        if (recipes.length === RECIPE_URLS.length) {
          console.log('All recipes loaded, saving to localStorage');
          saveRecipesToStorage(recipes);
          resolve(recipes);
        }

        // A9. TODO - If we have finished retrieving all of the recipes, save
        //            the recipes to storage using the function we have
        //            provided. Then, pass the recipes
      } catch (error) {
